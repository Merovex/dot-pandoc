...
\usebackgroundtemplate{%
  %FIX: \includegraphics[width=\paperwidth]{$background-image$}%
}
$endif$
...
\usepackage{xcolor}
$if(fancybreakcolor)$
  \definecolor{fancybreakcolor}{RGB}{$fancybreakcolor$}
$else$
  \definecolor{fancybreakcolor}{RGB}{215,215,217}
$endif$
\usepackage{fontawesome5}
\renewcommand{\pfbreakdisplay}{
  \textcolor{fancybreakcolor}{\footnotesize$fancybreak$}
...
% Frontmatter
  ...
  \begingroup
    ...
    \begin{center}
      ...
      \vspace*{2\drop}
      $if(imprint)$
      \includegraphics[width=26mm]{/Users/merovex/.local/share/pandoc/$imprint$}\\[0cm]
      \vspace*{7mm}
      $endif$
    \end{center}
    \clearpage
